...
*    Availability: https://gist.githubusercontent.com/alexjlockwood/646da27085a7cce9262d0402a0f2ab80/raw/6278c1f2e4d96fd78aae9f9ca9897c647be69b4a/index.js
***************************************************************************************/
function render(src) {
    const width = window.innerWidth/2;
    console.log(window.innerWidth);
    const height = window.innerHeight/1.076;
...
function loadJs(article) {
    
    if (article !== null) {
        populate(article,6,2).then(x => {
            console.log(x);
